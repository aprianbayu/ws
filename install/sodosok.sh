...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/${GitUser}/websocket/main/add-user/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/${GitUser}/websocket/main/delete-user/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/${GitUser}/websocket/main/cek-user/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/${GitUser}/websocket/main/renew-user/renew-ss.sh"
wget -O ssssr "https://raw.githubusercontent.com/${GitUser}/websocket/main/menu/ssssr.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
